...
#         print(f"Current pip source: {result.stdout.strip()}")
#     else:
#         print("No custom pip source found, using default.")
#
#
...
#
#     source_url = PIP_SOURCES[source_name]
#     result = subprocess.run(['pip', 'config', 'set', 'global.index-url', source_url], capture_output=True, text=True)
#
#     if result.returncode == 0:
#         print(f"Switched to {source_name} source: {source_url}")
#     else:
#         print(f"Failed to switch source: {result.stderr}")
#
#
# def list_sources():
#     print("Available pip sources:")
